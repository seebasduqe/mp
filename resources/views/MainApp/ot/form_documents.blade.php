...
<div class="position-relative form-group">
                        ...
                        @foreach ($array_document as $document)
                            <tr id="row_document_{{ $document->document_id }}">
                                ...
                                <td class="text-center"><a
                                        href="{{ asset('storage/ot_documents/' . $document->document_url) }}" download
                                ...
                                <td class="text-center">
                                    <button class="btn btn-danger delete_document" type="button"
                                        ...
                                        id="dlt_btn_province_{{ $document->document_id }}" title="Eliminar documento"><i
    ...
    <div class="position-relative form-group">
        ...
        <div class="mt-5 mb-3">
            @if ($type == 'create')
                <a href="{{ route('ot.index') }}"class="mt-1 btn btn-dark">
                    <i class="fa fa-save mr-2"></i>
                    Siguiente
                </a>
            @endif
    ...
    @section('custom_footer')
        <script type="text/javascript">
            ...
            var delete_document = "{{ route('ot.delete_document') }}";
        </script>
        <script type="text/javascript"
            src="{{ URL::asset('' . DIR_JS . '/main_app/ot/ot_document_view.js') }}?v={{ config('app.version') }}"></script>
    @endsection
