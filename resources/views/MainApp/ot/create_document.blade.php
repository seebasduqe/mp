    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Crear documentos
                    <div class="page-title-subheading">
                        Crear los documentos de la orden de trabajo
                    </div>
                </div>
            </div>
...
@section('main_content')
    ...
    <div class="row justify-content-center text-center mt-2">
        <div class="col-6">
            <div class="alert alert-primary" role="alert">
                Si no deseas añadir ningún documento puedes<strong><a href="{{ route('ot.index') }}"> finalizar la creación
                        de la ot.</a></strong>
    ...
    <div class="">
        {!! Form::open([
            'route' => ['ot.store_documents', $obj_ot->ot_id],
            'files' => true,
            'method' => 'POST',
            'id' => 'documents_form',
        ]) !!}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @include('MainApp.ot.form_documents')
            </div>
