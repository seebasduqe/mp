            ...
            <div class="page-title-heading">
                ...
                <div>Crear horas
                    <div class="page-title-subheading">
                        Crear las horas de la orden de trabajo
                    </div>
                </div>
            </div>
...
@section('main_content')
    ...
    <div class="row justify-content-center text-center mt-2">
        <div class="col-6">
            <div class="alert alert-primary" role="alert">
                Si no deseas añadir ninguna hora puedes ir al <strong><a
                        href="{{ route('ot.create_documents', $obj_ot->ot_id) }}"> siguiente paso.</a></strong>
    ...
    <div class="">
        ...
        {!! Form::open([
            'route' => ['ot.store_hours', $obj_ot->ot_id],
            'method' => 'POST',
            'id' => 'hours_form',
        ]) !!}
        @csrf
