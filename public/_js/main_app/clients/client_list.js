...
$(document).ready(function () {
    ...
    oTable_clients = $('#clientTbl').DataTable({
        ...
        "columnDefs": [
            ...
            { "targets": 3, "visible": true, "searchable": true, "bSortable": true, "sClass": "", "width": "138px" },//address
    ...
    $(document).on('click', '.delete_client', function (e) {
        ...
        let client_id = $(this).attr('data-attr');

        $.confirm({
            title: 'Eliminar Cliente',
            content: '¿Estas seguro que quieres eliminar el cliente?',
            buttons: {
                cancelar: {
                    text: 'Cancelar',
                    btnClass: 'btn-red',
